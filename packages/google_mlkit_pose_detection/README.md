...
```ruby
platform :ios, '26.0'  # or newer version

...

# add this line:
$iOSVersion = '26.0'  # or newer version
...
Notice that the minimum `IPHONEOS_DEPLOYMENT_TARGET` is 26.0, you can set it to something newer but not older.
